...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак админа",   1000),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед админа",      500),
            new Meal(2, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин админа",      510)
    );
